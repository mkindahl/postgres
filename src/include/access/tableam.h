...
typedef struct TableAmRoutine
{
	 ...
	 *
	 * To implement transactional behaviour, this call should just register
	 * the relation for removal on transaction commit. The table access method
	 * should register for transaction handling using RegisterXactCommit() and
	 * remove the phyiscal storage on a commit call.
	 *
